...
public static class RateLimitExtensions
{
    public static IServiceCollection AddApiRateLimiting(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddRateLimiter(limiter =>
        {
            ...
            limiter.AddPolicy(RateLimiting.Auth, context => Window(context, options => options.Auth));
            limiter.AddPolicy(RateLimiting.Accounts, context => Window(context, options => options.Accounts));
            limiter.AddPolicy(RateLimiting.Search, Bucket);
